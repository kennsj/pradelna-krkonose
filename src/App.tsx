			...
			<main>
				...
				<section data-background data-fullwidth>
					...
					>
						<AnimatedTextGroup>
							<p>
								Jsme profesionální prádelna v Krkonoších, která zajišťuje praní
								a mandlování prádla pro hotely, penziony, horské chaty,
								restaurace a další provozy.
							</p>
							<p className='bold'>
								Prádlo zpracováváme v souladu s hygienickými standardy, s
								důrazem na kvalitu a spolehlivost.
							</p>
							<p>
								Nabízíme pravidelnou, sezónní i nárazovou spolupráci podle
								...
								<div className='steps'>
									...
									<div className='step'>
										...
										<div>
											...
											<p className='step-text'>
												Společně nastavíme rozsah služeb, frekvenci svozu,
												sezónní kapacitu. Vše jasně, bez složitých smluv.
											</p>
										</div>
									</div>
									<div className='step'>
